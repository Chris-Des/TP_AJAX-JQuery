    ...
    <div class="content container">
        ...
        <form id="inscriptionForm" action="" method="POST">
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="username" id="username" oninput="checkUsernameRequirements()" required>
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control" name="password" id="password" oninput="checkPasswordRequirements()" required>
